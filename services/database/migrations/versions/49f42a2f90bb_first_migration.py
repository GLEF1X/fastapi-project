...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "unit_price", sa.Numeric(precision=8), server_default="1", nullable=True
        ),
        sa.Column(
            "size",
            sa.Enum("SMALL", "MEDIUM", "LARGE", "VERY_LARGE", name="sizeenum"),
            nullable=True,
        ),
    ...
    op.create_table(
        "users",
        sa.Column(
            "id", sa.BigInteger(), sa.Identity(always=True, cache=5), nullable=False
        ),
    ...
    op.create_table(
        "orders",
        sa.Column(
            "order_id", sa.Integer(), sa.Identity(always=True, cache=5), nullable=False
        ),
